...
//    }
    ...
    /**
     * @brief Массив с жанрами фильма
     * @return array
     */
    public function getGenres(): array
    {
        $cinemaGenreArray = [];
        foreach ($this->cinemaGenres as $cinemaGenre) {
            $genre = $cinemaGenre->genre;
            $cinemaGenreArray[] = [
                'id' => $genre->id,
                'name' => $genre->name,
            ];
        ...
        return $cinemaGenreArray;
    }

    /**
     * @brief Массив со странами фильма
     * @return array
     */
    public function getCountries(): array
    {
        $cinemaCountriesArray = [];
        foreach ($this->cinemaCountries as $cinemaCountry) {
            $country = $cinemaCountry->country;
            $cinemaCountriesArray[] = [
                'id' => $country->id,
                'name' => $country->name,
            ];
